...
export default function TicketCard({title, genre, id, posterUrl, showDelete}:TicketCardProps) {
  return (
    <article className={styles['ticket']}>
      <Image
        className={styles['ticket__poster']}
        src={posterUrl ? posterUrl : filmCover}
        width={100}
        height={120}
        alt="film cover"
      />
      ...
      <TicketCounter id={id}/>
     { showDelete && <button className={styles['ticket__delete']} type="button" title="Delete">
        <svg
          width="20"
          height="20"
          viewBox="0 0 20 20"
